        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HrefAvatar = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Medias",
                columns: new[] { "Id", "QuestionId", "Title", "Type", "Url" },
                values: new object[] { 4, null, "С коллегами", (byte)1, "https://www.b17.ru/foto/uploaded/upl_1637170559_396979_p74dn.jpg" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, 1, "Как прошел ваш рабочий день?" },
                    { 2, 2, 1, "С кем вы обычно ходите обедать?" },
                    { 3, 3, 1, "Как вы относитесь к своему начальнику?" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 3, "Ёжик в тумане. Мультфильм HD (1975г.)", (byte)2, "<iframe width=\"560\" height=\"315\" src=\"https://www.youtube.com/embed/6gS1Bp4LZLc\" title=\"YouTube video player\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture\" allowfullscreen></iframe>" },
                    { 2, 3, "Фото ёжика 1", (byte)1, "https://proprikol.ru/wp-content/uploads/2021/12/kartinki-ezhika-na-avu-32.jpg" },
                    { 3, 3, "Фото ёжика 2", (byte)1, "https://bugaga.ru/uploads/posts/2016-04/1461680876_ezhik-vampir-11.jpg" }
                });
